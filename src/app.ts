...
import { CreateProductUseCase } from "./core/usecases/product/create-product/create-product.usecase";
import { UpdateProductInterface } from "./core/usecases/product/update-product/update-product.interface";
import { UpdateProductUseCase } from "./core/usecases/product/update-product/update-product.usecase";
import { DeleteProductInterface } from "./core/usecases/product/delete-product/delete-product.interface";
import { DeleteProductUseCase } from "./core/usecases/product/delete-product/delete-product.usecase";
...
export class App {
  ...
  configDependencies(): void {
    container
      .bind<ListProductInterface>(TYPES.ListProductInterface)
      .to(ListProductUseCase),
      container
        .bind<CreateProductInterface>(TYPES.CreateProductInterface)
        .to(CreateProductUseCase),
      container
        .bind<UpdateProductInterface>(TYPES.UpdateProductInterface)
        .to(UpdateProductUseCase),
      container
        .bind<DeleteProductInterface>(TYPES.DeleteProductInterface)
        .to(DeleteProductUseCase),
      container
        .bind<ProductRepositoryInterface>(TYPES.ProductRepositoryInterface)
